  ...
  do
    ...
    do
      ...
      do
        ...
        --train_config_path="/home/taki/Otter/data_for_otter/data/training_data/0/"$dataset"_VI_pairs1_train.json" \
        --external_save_dir="./log" \
        --batch_size=$batch \
        --num_epochs=$epoch \
        --wandb_entity=yukiti21 \
        --run_name="1023_query-only_VI_batch"$batch"_pairs5_lr="$lr"_warmup="$warmup"_epoch="$epoch \
        --workers=1 \
        --learning_rate=$lr \
