      ...
      do
        ...
        do
          ...
          do 
            ...
            --images_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/wh256_train_kfold"$kf"_VI.json" \
            --train_config_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/train_kfold"$kf"_train.json" \
            --val_mimicit_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/test_kfold"$kf"_instructions.json" \
            --val_images_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/wh256_test_kfold"$kf"_VI.json" \
            --val_config_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/test_kfold"$kf"_train.json" \
            --external_save_dir="./log" \
            --batch_size=$batch \
            --run_name="one_input_256_w=256_"$res_name"_batch"$batch"_lr="$lr"_warmup="$warmup"_epoch="$epoch"_kf="$kf \
            --workers=1 \
            --lr_scheduler=cosine \
            --learning_rate=$lr \
            ...
            --images_path="/home/taki/Otter/data_for_otter/data/grain_dataset/"$res_name"/wh256_"$dataset"_kfold"$kf"_VI.json" \
